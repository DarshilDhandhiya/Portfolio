            ...
            <div className='h-full mt-4'>
                <div className='relative flex flex-col items-center justify-center'>
                    ...
                    <div className='flex flex-row flex-wrap items-center justify-center gap-3 mt-4 lg:hidden'>
                        ...
                        <AnimatedImage initial={{ y: 50, opacity: 0 }} animate={inView ? { y: 0, opacity: 1 } : {}} transition={{ duration: 0.5, delay: 0.6 }} className="z-[1] hover:cursor-pointer w-[100px] h-[100px]" src={assets.home.letsConnect.x} alt='' width={100} height={100} tabIndex={0} onClick={() => window.open('https://instagram.com/deri561', '_blank')} />
